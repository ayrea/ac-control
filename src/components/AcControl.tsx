...
import { Button, Grid, MenuItem, Select, SelectChangeEvent, SvgIcon, Switch, SxProps, Typography } from '@mui/material';
    ...
    return (
        <Paper elevation={6} sx={{ maxWidth: "550px" }}>
            <Grid container spacing={1}>
                <Grid size={12} m={1} pl={2} bgcolor={"lightgrey"} justifyItems={'left'} borderRadius={3} sx={{ bgcolor: "#d7e4ef" }}>
                    <Typography variant='h4'>AC Control</Typography>
                </Grid>

                <Grid size={4} justifyItems={'right'}>
                    <Typography variant='h6' mt={2}>Power:</Typography>
                </Grid>

                <Box display={"flex"} sx={{ ...commonStyles, width: "250px" }}>
                    <Grid size={8} justifyItems={'left'}>
                        <Box display={"flex"}>
                            <Box m={1} display={"flex"}>
                                ...
                                <Typography variant='h4' mx={7.5} mt={0.5}>{acState.onOff ? "On" : "Off"}</Typography>
                            </Box>
                        </Box>
                    </Grid>
                </Box>

                <Grid size={5} my={2} justifyItems={'right'}>
                    <Typography variant='h6' mt={"4px"}>Current Temp:</Typography>
                </Grid>
                <Grid size={7} my={2} justifyItems={'left'}>
